...
const addBackground = (root) => {
  ...
  // root.append(btn);
  // const restat = () => {
  //   restat = document.querySelector("btn");
  //   document.addEventListener("onClick", restat);
  // };
  ...
  whiteBox.style.height = "90px";
  whiteBox.style.width = `${GAME_WIDTH}px`;
  whiteBox.style.background = "#fff";
  // whiteBox.innerText = "Flying Game";
  // whiteBox.innerHTML = button;
